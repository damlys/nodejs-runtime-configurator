...
import { EnvironmentVariables, EnvironmentVariablesSource } from "../../src/Sources/EnvironmentVariablesSource";
...
test("should process APP variables", () => {
    ...
    const envsSource: ConfigurationSourceInterface = new EnvironmentVariablesSource(envs, "APP");
...
test("should process MY_APP variables", () => {
    ...
    const envsSource: ConfigurationSourceInterface = new EnvironmentVariablesSource(envs, "MY_APP");
    expect(envsSource.resolve())
        .toEqual({
            alpha: "beta",
        });
